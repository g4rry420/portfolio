...
export default function Projects() {
    const [content, setContent] = useState([
        ...
        { id: 11, imgUrl: `${require("../../images/notes_serverless.PNG")}`, webUrl: "https://notes-pink.vercel.app/", title: "Notes - A CRUD application", tech: "AWS, Lambda, S3, IAM, DynamoDb, React, Node" },
